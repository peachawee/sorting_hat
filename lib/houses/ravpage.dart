...
class RavPage extends StatefulWidget {
  const RavPage({Key? key}) : super(key: key);

  @override
  State<RavPage> createState() => _RavPageState();
}

class _RavPageState extends State<RavPage> {
  @override
        ...
        child: Container(
          decoration: const BoxDecoration(
              image: DecorationImage(
                image: AssetImage("assets/images/flag3.jpg"),
                fit: BoxFit.cover,
              )),
          child: Column(
            children: [
              ...
              Expanded(
                child: ListView.builder(
                    itemCount: Ravenclaw.length,
                    itemBuilder: (context, i) {
                      var value = Ravenclaw[i].done1;
                      return Padding(
